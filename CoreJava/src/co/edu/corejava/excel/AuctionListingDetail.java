package co.edu.corejava.excel;

public class AuctionListingDetail {
	...
	public int getAtaChapterId() {
		return ataChapterId;
	}

	public void setAtaChapterId(int ataChapterId) {
